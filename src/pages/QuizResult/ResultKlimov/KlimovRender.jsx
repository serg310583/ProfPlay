...
import { ScaleKlimov } from './../ResultScales/Klimov/ScaleKlimov'
		...
		<section className={styles.sectionResult}>
			<div className={styles.sectionResult_window}>
				...
				<div className={styles.consultationBlock}>
					...
					<TelegramShareButton
						title={
							'Перейдя по ссылке можно посмотреть результаты прохождения теста на профориентацию Е.А. Климова'
						}
						url={currentUrl}
